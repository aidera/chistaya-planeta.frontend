...
describe('TablePageComponent', () => {
  ...
  describe('common', () => {
    ...
    it(
      'should update vars correctly if setInitialRequestSettings is called',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.ngOnInit();
          fixture.detectChanges();
  ...
  describe('forms', () => {
    it(
      'should define advancedSearchForm at the ngOnInit hook',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.ngOnInit();
          fixture.detectChanges();
    ...
    it(
      'should set current form correctly',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
    ...
    it(
      'should set initial settings if we change a current form',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('quick');
          fixture.detectChanges();
    ...
    it(
      'should add search query param if the search field is not empty',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('quick');
          fixture.detectChanges();
    ...
    it(
      'should remove search query param if the search field becomes empty',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('quick');
          fixture.detectChanges();
          ...
          fixture.whenStable().then(() => {
            expect(decodeURIComponent(location.path())).not.toContain(
              'search='
            );
          });
        });
    ...
    it(
      'should add filter query param if one of the fields is not empty',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('advanced');
          fixture.detectChanges();
    ...
    it(
      'should remove filter query param if all filter fields become empty',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('advanced');
          fixture.detectChanges();
    ...
    it(
      'should add date filter query param',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('advanced');
          fixture.detectChanges();
    ...
    it(
      'should have several filters query param',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('advanced');
          fixture.detectChanges();
    ...
    it(
      'should have only filters query param if there are search and filter values',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
          component.setCurrentForm('advanced');
          fixture.detectChanges();
    ...
    it(
      'should add sortField and sortType if there is a sorting',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
  ...
  describe('table', () => {
    ...
    it(
      'should set new sort if onTableSort is called',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
    ...
    it(
      'should set new pagination if onTablePaginate is called',
      waitForAsync(() => {
        fixture.ngZone.run(() => {
