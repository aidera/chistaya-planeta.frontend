...
describe('AddOrderNoAuthComponent', () => {
  ...
  //   component.form.controls.type.setValue(OrderType.service + '');
  //   fixture.detectChanges();
  //
  //   const fields = fixture.debugElement.queryAll(By.css('[fieldid]'));
  //
  ...
  //   component.form.controls.type.setValue(OrderType.offer + '');
  //   fixture.detectChanges();
  //
  //   const fields = fixture.debugElement.queryAll(By.css('[fieldid]'));
  //
  ...
  // });
  //
  // it('should has required validation error for the rawType field, if the
  // rawType field is empty and the type field is recyclable', () => {
  //   component.form.controls.type.setValue(OrderType.offer + '');
  //
  ...
  // });
  //
  // it('should not has required validation error for the rawType field, i
  // f the rawType field is empty and the type field is garbage', () => {
  //   component.form.controls.type.setValue(OrderType.service + '');
  //
  //   const field = component.form.get('rawType');
  //
  ...
  // });
  //
  // it('should has required validation error for the rawAmountUnit field,
  // if the rawAmountUnit field is empty and the type field is recyclable', () => {
  //   component.form.controls.type.setValue(OrderType.offer + '');
  //
  ...
  // });
  //
  // it('should has not required validation error for the rawAmountUnit field,
  // if the rawAmountUnit field is empty and the type field is garbage', () => {
  //   component.form.controls.type.setValue(OrderType.service + '');
  //
  //   const field = component.form.get('rawAmountUnit');
  //
  ...
  // });
  //
  // it('should has required validation error for the division field,
  ...
  // });
  //
  // it('should has not required validation error for the division field,
  ...
  //   () => {
  //     component.form.get('type').setValue(OrderType.offer + '');
